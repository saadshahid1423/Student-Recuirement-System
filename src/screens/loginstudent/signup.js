...
class Signup extends React.Component{
  constructor(props){
    super(props)
    this.state={
        UserName:"",Email:"",Password:"",PhoneNum:"",Marks:"",Gender:"",College:"",City:""
    }
}
 ...
 send_data = () =>{
   ...
   var obj = {
    ...
    if (this.state.UserName.trim() === "") {
        ...
        this.setState(() => ({ nameError: "Fill above feild." }));
    }else if (this.state.Marks.trim() === "") {
      this.setState(() => ({ nameError: "Fill above feild." }));
    }else if (this.state.Gender.trim() === "") {
      this.setState(() => ({ nameError: "Fill above feild." }));
    }else if (this.state.College.trim() === "") {
      this.setState(() => ({ nameError: "Fill above feild." }));
    }
     else {
        auth()
        ...
        .then(() => {
            ...
            database().ref('/').child('Students').push(obj)
            .then((success)=>{
    ...
    render(){
        return(
            ...
            <View style={styles.box} >
              <Text style={styles.head}>SignUp As Student</Text>
            ...
            <TextInput style={styles.Input1} value={this.state.Marks} onChangeText={(e)=>this.setState({Marks:e})} keyboardType="number-pad" placeholder="Total Marks" />
            <TextInput style={styles.Input1} value={this.state.Gender} onChangeText={(e)=>this.setState({Gender:e})} placeholder="Gender" />
            <TextInput style={styles.Input1} value={this.state.College} onChangeText={(e)=>this.setState({College:e})} placeholder="Name Of College" />
            ...
            <Text style={{marginTop:10,textAlign:"center",color:"#676767"}}>Already have an Account? <TouchableOpacity onPress={this.student}><Text style={styles.signup}>Login</Text></TouchableOpacity></Text>
              </View>
            </View>
        );
    };
